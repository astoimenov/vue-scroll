        ...
        install: function(Vue, options) {
                ...
                var addScrollListener = function(element, funcs) {
                    if (element == document.body) {
                        document.onscroll = function(e) {
                            var topPos = (document.documentElement && document.documentElement.scrollTop) || document.body.scrollTop;
                            var leftPos = (document.documentElement && document.documentElement.scrollLeft) || document.body.scrollLeft;

                            funcs.forEach(function(func) {
                                func && func(e, { scrollTop: topPos, scrollLeft: leftPos });
                            })
                        }
            ...
            Vue.directive('scroll', {
                bind: function(el, binding, vnode) {
                    ...
                    q.bind(document.body, EVENT_SCROLL, binding.value);
                },
                ...
                unbind: function(el, binding) {
                    if (binding.value && typeof binding.value === 'function') {
                        q.unbind(document.body, EVENT_SCROLL, binding.oldValue);
                    } else {
                        throw new Error('The scroll listener is not a function');
                    }
                }
